...
document.querySelector("#Lightcookie-btn1").addEventListener("click", () => {
    setCookie("Lightcookie", true, 30);
    location.reload();
})
document.querySelector("#Lightcookie-btn2").addEventListener("click", () => {
    setCookie("Lightcookie", false, 30);
    location.reload();
})
...
let cookieValue = getCookieValue("Lightcookie");
